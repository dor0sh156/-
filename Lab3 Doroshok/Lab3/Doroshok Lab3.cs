namespace Lab3
{
    public partial class Form1 : Form
    {
        ...
        int[,] matr_rot = new int[3, 3]; // матрица поворота
        ...
        private void Init_matr_rot(int angle)
        {
            ...
            matr_rot[0, 0] = (int)Math.Round(cos); matr_rot[0, 1] = (int)Math.Round(-sin); matr_rot[0, 2] = 0;
            matr_rot[1, 0] = (int)Math.Round(sin); matr_rot[1, 1] = (int)Math.Round(cos); matr_rot[1, 2] = 0;
        ...
        private void Draw_Figure()
        {
            ...
            int[,] transformedFigure = Multiply_matr(figure, matr_rot);

            // Применяем отражение по оси X, если включено
            if (isReflectedOverX)
            {
                transformedFigure = Multiply_matr(transformedFigure, new int[,] { { 1, 0, 0 }, { 0, -1, 0 }, { 0, 0, 1 } });
            }

            int[,] figure1 = Multiply_matr(transformedFigure, matr_sdv);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            // Инициализируем матрицу поворота с новым углом
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            // Инициализируем матрицу поворота с текущим углом (по умолчанию 0)
            Init_matr_rot(rotationAngle);
        ...
        private void Init_matr_scale(double scaleFactor)
        {
            ...
            matr_rot[0, 0] = (int)Math.Round(scaleFactor); matr_rot[0, 1] = 0; matr_rot[0, 2] = 0;
            matr_rot[1, 0] = 0; matr_rot[1, 1] = (int)Math.Round(scaleFactor); matr_rot[1, 2] = 0;
            matr_rot[2, 0] = 0; matr_rot[2, 1] = 0; matr_rot[2, 2] = 1;
        }
    }
}